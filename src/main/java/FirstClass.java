public class FirstClass {
    public static void main(String[] args) {
        Notebook notebook = new Notebook(600, 1000, 2000); //typ zmiennej jest taki jak nazwa klasy - klasa to foremka a obiekt to ciastko
       ...
       // }
        ...
        Notebook heavyNotebook = new Notebook(2000, 2000, 2003);
        ...
        Notebook oldNotebook = new Notebook(1200, 200, 1990);
